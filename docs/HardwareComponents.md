...
> consumed by `tools/dev/run_synthesis_sweep.py`. Regenerate via
> `python3 tools/dev/run_synthesis_sweep.py`; committed snapshots live in
> `workflow/runs/e2/`.
...
python3 tools/dev/run_synthesis_sweep.py          # regenerates workflow/runs/e2/
```
