...
METRIC_KEYS = [
    ...
    # B2.4 — energy-model breakdown (pulled from `run_single_config` metrics).
    "energy_npu_compute_mj",
    "energy_npu_systolic_mj",
    "energy_npu_vector_mj",
    "energy_npu_idle_mj",
    "energy_pim_access_mj",
    "energy_pim_read_mj",
    "energy_pim_write_mj",
    "energy_pim_leak_mj",
    "energy_bus_mj",
    "energy_gtsu_mj",
    "energy_aau_savings_mj",
